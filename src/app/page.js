export default function Home() {
  return (
    <div class="w-screen h-screen rounded-sm overflow-hidden shadow-lg bg-mirage-500">
      <img
        class="object-cover rounded-full h-40 w-40 mx-auto mt-8 p-1"
        src="/NammaAcademy.png"
        alt="Namma Academy"
      />
      ...
      <div class="flex flex-col mx-auto text-mirage-500">
        <a
          href="https://www.youtube.com/channel/UC0v3jYWm200ATyXv-MTYSLg?sub_confirmation=1"
          target="__blank"
        ...
        <a
          href="https://www.linkedin.com/company/nammaacademy/"
          target="__blank"
          class="flex flex-row mx-auto my-2 bg-white w-2/4 text-mirage-500 py-2 pl-2 rounded-md hover:border-r-yellow-500 border-r-4"
        >
          <svg
          ...
          <h4 class="my-auto font-semibold mx-5">LinkedIn</h4>
        </a>
        <a
          href="https://twitter.com/nammaacademy"
          target="__blank"
          class="flex flex-row mx-auto my-2 bg-white w-2/4 text-mirage-500 py-2 pl-2 rounded-md hover:border-r-yellow-500 border-r-4"
        >
          <svg
        ...
        <a
          href="https://www.instagram.com/nammaacademy/"
          target="__blank"
          class="flex flex-row mx-auto my-2 bg-white w-2/4 text-mirage-500 py-2 pl-2 rounded-md hover:border-r-yellow-500 border-r-4"
        >
          <svg
        ...
        <a
          href="https://www.facebook.com/nammaacademy"
          target="__blank"
          class="flex flex-row mx-auto my-2 bg-white w-2/4 text-mirage-500 py-2 pl-2 rounded-md hover:border-r-yellow-500 border-r-4"
        >
          <svg
        ...
        <a
          href="https://github.com/nammaacademy"
          target="__blank"
          class="flex flex-row mx-auto my-2 bg-white w-2/4 text-mirage-500 py-2 pl-2 rounded-md hover:border-r-yellow-500 border-r-4"
        >
          <svg
      ...
      <div class="text-white text-xs text-center mt-12 mb-4">
        Built by{" "}
        <a
          href="https://www.linkedin.com/in/helloamarnath/"
          target="__blank"
          class="border-b-yellow-500 border-b-2"
        >
          {" "}
          Amarnath TSR
        </a>
